...
make sync-catalog`,
      ...
      <DocsProse>
        ...
        <ul>
          <li>
            <Link href="/docs/multi-database">Multi-database routing</Link> — register DuckDB, SQLite,
            MySQL, ClickHouse, or extra Postgres backends and pass <code>database_id</code> on query,
            chat, and schema
          </li>
          <li>
